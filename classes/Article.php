...
class Article
{
     ...
     * @param mixed $conn Connection to the database
     ...
     * @param PDO $conn Connection object to the database
    ...
    protected function validate()
    {
        ...
        // if ($published_at !== '') {
        //     $date = date_create_from_format('Y-m-d H:i:s', $published_at);
     ...
     * @param PDO $conn Connection object to the database
     * @return bool True if the article is deleted successfully, false otherwise
     */
    ...
    /**
     * Publish the article, setting the published_at field the current date and time
     * @param object $conn Connection to the database
